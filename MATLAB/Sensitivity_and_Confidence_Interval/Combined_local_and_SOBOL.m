...
set(gca,'YScale','log','XTickLabel',labels,'TickLabelInterpreter','latex','FontName','Arial','FontSize',12)
ylim([10e-8 10e-1])
...
xlabel('Parameters','FontName','Arial','FontSize',12)
ylabel('Sobol indices','FontName','Arial','FontSize',12)
labels={'$B$', '$D_{Chi}$', '$D_{PCL}$', '$\kappa$'};
set(gca,'YScale','log','XTickLabel',labels,'TickLabelInterpreter','latex','FontName','Arial','FontSize',12)
ylim([10e-8 10e-1])
