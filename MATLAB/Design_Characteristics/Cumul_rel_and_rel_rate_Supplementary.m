...
file_name = 'Bilayered_MPs_Prediction_Supplementary.xlsx'; %Reading spreadsheet
...
axisvector = [0 360 0 100.1];
xtickvector = [0 60 120 180 240 300 360];
