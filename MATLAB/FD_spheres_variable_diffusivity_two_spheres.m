...
%   Finite difference discretization scheme for spheres
%   with grid spacing and alpha different in the two layers
%   partition coefficient at the interface allowed
%% --- Input ---
